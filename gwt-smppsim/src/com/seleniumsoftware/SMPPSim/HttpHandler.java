 ...
 * $Header: /var/cvsroot/SMPPSim2/src/java/com/seleniumsoftware/SMPPSim/HttpHandler.java,v 1.12 2008/11/08 11:40:27 martin Exp $
 ****************************************************************************
 */
...
public class HttpHandler implements Runnable {
	...
	private String dest_addr = "337788665522";
...
//			logger.info(token);
		...
		if (args.containsKey("tlv1_tag")) {
			...
			byte[] val = makeBinaryMessage(args.get("tlv1_val"));
		...
		if (args.containsKey("tlv2_tag")) {
			...
			byte[] val = makeBinaryMessage(args.get("tlv2_val"));
		...
		if (args.containsKey("tlv3_tag")) {
			...
			byte[] val = makeBinaryMessage(args.get("tlv3_val"));
		...
		if (args.containsKey("tlv4_tag")) {
			...
			byte[] val = makeBinaryMessage(args.get("tlv4_val"));
