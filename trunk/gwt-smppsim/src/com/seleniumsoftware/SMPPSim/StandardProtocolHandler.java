 ...
 * $Header: /var/cvsroot/SMPPSim2/src/java/com/seleniumsoftware/SMPPSim/StandardProtocolHandler.java,v 1.8 2009/01/07 20:04:15 martin Exp $
 ****************************************************************************/
...
public class StandardProtocolHandler {
	...
	void getSubmitSMResponse(byte[] message, int len) throws Exception {
		...
		// logPdu(":SUBMIT_SM_RESP (ESME_RINVSRCADR):", resp_message, smppresp);
		// connection.writeResponse(resp_message);
		// smsc.writeDecodedSmppsim(smppresp.toString());
		// smsc.incSubmitSmERR();
		// return;
	...
	private void logPdu(String label, byte[] message, Pdu pdu) {
