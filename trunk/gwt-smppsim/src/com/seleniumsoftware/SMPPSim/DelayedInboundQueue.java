 ...
 * $Header: /var/cvsroot/SMPPSim2/src/java/com/seleniumsoftware/SMPPSim/DelayedInboundQueue.java,v 1.1 2009/01/07 20:04:15 martin Exp $
 ****************************************************************************
 */
...
public class DelayedInboundQueue implements Runnable {
	...
	public void run() {
		...
		while (true) {
			...
			logger.info("Processing " + dcount
					+ " messages in the delayed inbound queue");
